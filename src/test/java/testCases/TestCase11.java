...
public class TestCase11 extends BaseTest {
    ...
    public void TC11() throws InterruptedException {
        ExtentTest testLogger = getExtent().createTest("TestCase_011");
        setTest(testLogger);
        testLogger.info("Verify user login via Base Test 11");
        ...
        testLogger.pass("Is UserTextBox Present (via POM)?: " + userTextBoxPresent);

        hrmLoginPage.login("Admin", "admin123");
        Thread.sleep(3000);

        testLogger.info("Password is hidden ##");
